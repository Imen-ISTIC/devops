...
public class EventServicesImpl implements IEventServices {
    ...
    public Event addAffectEvenParticipant(Event event, int idParticipant) {
        ...
        if (participant != null) {
            ...
            // Handle the case where participant is null (maybe throw an exception or log an error)
            return null;
        }
    }
    ...
    public Logistics addAffectLog(Logistics logistics, String descriptionEvent) {
        ...
        if (event != null) {
            ...
            // Handle the case where event is null (maybe throw an exception or log an error)
            return null;
        }
    }
